...
import { AlertTriangle, Shield, Eye, EyeOff, ArrowLeft, Lock, Unlock, Bug, Info, Zap } from 'lucide-react'
  ...
  const vulnerabilities = [
    {
      ...
      title: 'SQL Injection',
      severity: 'Critical',
      description: 'The login form is vulnerable to SQL injection attacks. User input is not properly sanitized.',
      example: "Try entering: admin' OR '1'='1' -- as username",
      impact: 'Attackers can bypass authentication, access unauthorized data, or manipulate the database.',
    ...
    },
    {
      ...
      severity: 'High',
      description: 'The application uses weak default credentials that are easily guessable.',
      example: 'Username: admin, Password: admin',
      impact: 'Unauthorized access to administrative functions and sensitive data.',
      remediation: 'Enforce strong password policies and require password changes on first login.'
    },
    {
      id: 'no_csrf',
      title: 'Missing CSRF Protection',
      severity: 'Medium',
      description: 'The login form lacks CSRF tokens, making it vulnerable to cross-site request forgery.',
      example: 'Malicious sites can submit login requests on behalf of users.',
      impact: 'Attackers can perform unauthorized actions using victim\'s session.',
    ...
    },
    {
      ...
      severity: 'Medium',
      description: 'The login endpoint has no rate limiting, allowing brute force attacks.',
      example: 'Unlimited login attempts are possible.',
      impact: 'Attackers can perform brute force attacks to guess credentials.',
      remediation: 'Implement rate limiting, account lockouts, and CAPTCHA after failed attempts.'
    },
    {
      id: 'password_exposure',
      title: 'Password Field Exposure',
      severity: 'Low',
      description: 'Password field can be toggled to plain text, potentially exposing passwords.',
      example: 'Click the eye icon to reveal the password.',
      impact: 'Shoulder surfing attacks and accidental password exposure.',
      remediation: 'Consider removing password visibility toggle or add warnings.'
    }
  ]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Alert className="mb-8 border-red-500 bg-red-900/20 backdrop-blur-sm">
          ...
          <AlertDescription className="text-red-300">
            <strong>Educational Purpose Only:</strong> This is an intentionally vulnerable login form 
            designed for security testing and education. Do not use this code in production environments.
          </AlertDescription>
        </Alert>
          ...
          <div>
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Test various security vulnerabilities in this intentionally insecure login form
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="mt-4">
                    {loginResult === 'sql_injection' && (
                      <Alert className="border-red-500 bg-red-900/20">
                        ...
                        <AlertDescription className="text-red-300">
                          <strong>SQL Injection Detected!</strong> The application is vulnerable to SQL injection. 
                          In a real scenario, this could lead to database compromise.
                        </AlertDescription>
                      </Alert>
                    )}
                    ...
                    {loginResult === 'weak_credentials' && (
                      <Alert className="border-orange-500 bg-orange-900/20">
                        ...
                        <AlertDescription className="text-orange-300">
                          <strong>Weak Credentials!</strong> You successfully logged in with default credentials. 
                          This represents a serious security risk.
                        </AlertDescription>
                      </Alert>
                    )}
                    ...
                    {loginResult === 'invalid_credentials' && (
                      <Alert className="border-gray-500 bg-gray-900/20">
                        ...
                        <AlertDescription className="text-gray-300">
                          Invalid credentials. Try testing the vulnerabilities listed on the right.
                        </AlertDescription>
                      </Alert>
                    )}
            ...
            <Card className="mt-6 bg-gray-800/50 border-gray-700 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Try these inputs to test different vulnerabilities</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="p-3 border border-gray-700 rounded-lg bg-gray-900/30">
                    <h4 className="font-medium text-white">SQL Injection Test</h4>
                    <p className="text-sm text-gray-400 mt-1">
                      Username: <code className="bg-red-900/30 text-red-300 px-1 rounded">admin' OR '1'='1' --</code>
                    </p>
                    <p className="text-sm text-gray-400">Password: <code className="bg-gray-700 text-gray-300 px-1 rounded">anything</code></p>
                  </div>
                  
                  <div className="p-3 border border-gray-700 rounded-lg bg-gray-900/30">
                    <h4 className="font-medium text-white">Default Credentials</h4>
                    <p className="text-sm text-gray-400 mt-1">
                      Username: <code className="bg-orange-900/30 text-orange-300 px-1 rounded">admin</code>
                    </p>
                    <p className="text-sm text-gray-400">Password: <code className="bg-orange-900/30 text-orange-300 px-1 rounded">admin</code></p>
                  </div>
                  
                  <div className="p-3 border border-gray-700 rounded-lg bg-gray-900/30">
                    <h4 className="font-medium text-white">Password Visibility</h4>
                    <p className="text-sm text-gray-400 mt-1">
                  ...
                  {vulnerabilities.map((vuln) => (
                    <div 
                      ...
                      className={`p-3 border border-gray-700 rounded-lg cursor-pointer transition-all duration-200 ${
                        selectedVulnerability === vuln.id ? 'border-cyan-500 bg-cyan-900/10' : 'hover:bg-gray-900/30'
                      }`}
